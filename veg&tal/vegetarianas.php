...
<head>
    <title>Veg&tal - Culinária Vegetariana</title>
...
<body>
    ...
    <div class="content">
        ...
        <div class="text"><h1>Culinária Vegetariana</h1></div>
        ...
        <div class='food-table'>
            ...
            $sql = "SELECT * FROM receitas WHERE tipo = 'Vegetariana' ORDER BY nome";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td style='text-align: center; text-decoration: none;'><a href='" . $row["link"] . "' style='text-decoration: none;'>Ver Receita</a></td>";
                    echo "</tr>";
                }
                echo "</table>";
            }
